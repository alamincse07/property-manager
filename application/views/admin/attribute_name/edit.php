...
<div class="span10 content">
	...
	<div class="widget">
		...
		<div class="widget-head">
			<h3 class="heading">
				<?php 
					echo lang('estate_attr_name_message_edit');
				?>
			</h3>
		</div>
		<div class="widget-body">
			<?php echo form_open('admin/estateAttributeEdit'); ?>
				<input type="hidden" name='id' value="<?php echo $this->uri->segment(3);?>">
				<table width="100%" cellpadding="5" cellspacing="0" border="0">
					<tbody>
						<tr>
							<td><?php echo lang('sidebar_estate_attr_name') ?></td>
							<td><input type="text" name="name" required class="span" value="<?php if($values){ echo $values['name']; } ?>"></td>
						</tr>
						<tr>
							<td><?php echo lang('sidebar_estate_attr_position') ?></td>
							<td><input type="text" name="position" required class="span" value="<?php if($values){ echo $values['position']; } ?>"></td>
						</tr>
						<tr>
							<td colspan="2">
