...
<div class="span10 content">
    ...
    <div class="contentArea">
        ...
        <div class="widget">
            <div class="widget-head"><h3 class="heading"><?php echo $first_name['value'] . lang('edituser_add_h2_title') ?></h3></div>
