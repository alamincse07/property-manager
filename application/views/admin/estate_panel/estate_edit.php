          ...
          <div class="widget-head"><h3 class="heading"><?php echo lang('blog_edit_widget_title') ." ". $title['value'] ?></h3></div>
            ...
            <div>	
            	 ...
            	 <table width="100%" cellpadding="5" cellspacing="0" border="0">
                	...
                	<tr>
                		<td><?php echo form_dropdown('country', $country, $countryAC, 'class="country span" id="country" onchange="set_country_marker();"'); ?></td>
                		<td><?php echo form_dropdown('province', $province, $provinceAC, 'class="province span" id="province" onchange="set_state_marker();"'); ?></td>
    ...
    $(function () {
        ...
        else
        {
            $("#mapCanvas").gmap3({
                map:{
                    options:{
                        center: [<?php echo ($coordinates != '') ? $coordinates : '53.81388459999999, -124.929416899999978';?>],
                        zoom: 6
                    }
                }
            });
